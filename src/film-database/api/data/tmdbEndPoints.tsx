...
export const tmdbEndPoints = {
  ...
  trending: [
    { key: 'trendingMovies', endPoint: 'https://api.themoviedb.org/3/trending/movie/{time_window}' },
    { key: 'trendingTv', endPoint: 'https://api.themoviedb.org/3/trending/tv/{time_window}' },
  ],
};
