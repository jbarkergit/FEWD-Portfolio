...
const FDAccountHeader = ({ toggleComponent }: Type_PropDrill) => {
  ...
  return (
    <header className='fdAccountHeader'>
      <nav className='fdAccountHeader__nav'>
        <ul className='fdAccountHeader__nav__ul'>
          <li className='fdAccountHeader__nav__ul__li'>
...
export default FDAccountHeader;
