...
const EcommerceExtendedInfo = ({ setProjectDetail }: EcommerceProjectInfoType): JSX.Element => {
  return (
    <article className='projectDetails__projectOverview'>
      ...
      <section className='projectDetails__projectOverview__information'>
        ...
        <p>
          The implementation of Dynamic Audio was influenced by React Native behaviors and code splitting methodology. I utilized a single useState hook within
          context to streamline logic and complexity, ultimately reducing initial page load times. This approach posed challenges, such as the need to persist data
          across page loads, individual product category pages, filtered pages and managing React Router Dom routes which are mapped by gathering unique sets of
          companies, product categories and styles. All of which were explored, rethought and refactored until I could no longer improve upon performance.
        </p>
        <p>
          ...
          find I'm more opinionated on topics now but still challenge myself, opinions and knowledge. Naturally, unit testing become a topic of concern. Given I
          opted into using Vite to bundle my application, I also chose to use Vitest to help me produce reliable code. Along the journey, I learned to counteract
          warnings and bugs prompted by React and learned its opinionated rules such as not using indexes from maps for unique keys.
        </p>
        <p>
        ...
        <p>
          ...
          possible refactoring code structure to conceptualize and test complex layouts. Having had owned an eCommerce business prior to this web development
          journey, I seated the user experience at the table of consideration, ultimately settling on a blend of my own ideas and pieces of style structures from
          other domains such as Apple, RollieNation, NewEgg and miscellaneous domains from awwwards for both the desktop layout and the mobile layout. I did not aim
          to re-invent the wheel, nor make anything grand and unique; rather, learn. I did; however, find myself questioning the lack of 2K monitor scaling support,
          which I believe to be lacking in the industry given the comparison of statistics from when developers stop supporting browsers based on user usage and
          Steam's user data.
        </p>
        <p>
