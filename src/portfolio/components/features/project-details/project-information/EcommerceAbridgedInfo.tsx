      ...
      <section className='projectDetails__projectSummary__information'>
        ...
        <p>
          ...
          <span>
            ...
            React Router Dom routes by mapping unique sets of companies, product categories, and styles. Identified and managed rerenders and side effects.
            Refactored component architecture until performance was satisfactory. Minimalized logic by adopting constructor patterns. Centering divs.
          </span>
        </p>
        <p>
          <span>Best Practices</span>
          <span>
            Adopted DRY and BEM methodology, componentization and opinionated file structuring guidelines, documentation for code legibility and maintenance
            alongside explicit variable naming, lazy loading, font loading optimization and my own opinionated prop drilling limititations - Three components deep if
            file structure is organized, else restructuring and optimization will ensue for code organization and readability. Used data fallbacks in the event that
        ...
        <p>
          ...
          <span>Employed React's useReducer to handle product logic and local storage for data persistence across page loads.</span>
        </p>
        <p>
          <span>User Experience</span>
          <span>
            Achieved a balanced blend of personal design conceptualization and pre-existing, established style structures from various sources. Didn't aim to
