...
const EcommerceTechStack = () => {
  ...
  return (
    <section className='projectDetails__projectSummary__techStack' style={{ paddingTop: '0.6rem' }}>
      <span>
        <button id='nodejs' aria-label='Node.js Runtime Environment' data-status='false' onClick={() => useTechStack} ref={techButton}>
          <svg xmlns='http://www.w3.org/2000/svg' width='1.88em' height='2em' viewBox='0 0 256 292'>
            <defs>
              <path
      ...
      <span>
        <button id='npm' aria-label='Node Package Manager' data-status='false' onClick={() => useTechStack} ref={techButton}>
          <svg xmlns='http://www.w3.org/2000/svg' width='4.11em' height='2em' viewBox='0 0 512 165'>
            <path
              fill='#C12127'
      ...
      <span>
        <button id='html' aria-label='ESLint' data-status='false' onClick={() => useTechStack} ref={techButton}>
      ...
      <span>
        <button id='html' aria-label='ESLint' data-status='false' onClick={() => useTechStack} ref={techButton}>
          <svg xmlns='http://www.w3.org/2000/svg' width='1.86em' height='2em' viewBox='0 0 439 512'>
            <path
              fill='#ffffff'
      ...
      <span>
        <button id='vite' aria-label='Vite' data-status='false' onClick={() => useTechStack} ref={techButton}>
          <svg xmlns='http://www.w3.org/2000/svg' width='2em' height='2em' viewBox='0 0 256 257'>
            <defs>
      ...
      <span>
        <button id='react' aria-label='React' data-status='false' onClick={() => useTechStack} ref={techButton}>
          <svg xmlns='http://www.w3.org/2000/svg' width='2.13em' height='2em' viewBox='0 0 256 228'>
            <path
              fill='#00D8FF'
      ...
      <span>
        <button id='reactrouterdom' aria-label='React Router Dom' data-status='false' onClick={() => useTechStack} ref={techButton}>
          <svg xmlns='http://www.w3.org/2000/svg' width='3em' height='2.8em' viewBox='0 0 128 128'>
            <path
              fill='#F44250'
