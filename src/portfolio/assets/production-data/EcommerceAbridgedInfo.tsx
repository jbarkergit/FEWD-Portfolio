  ...
  return (
    <article className='projectDetails__projectSummary'>
      ...
      <p>
        Key Highlights:
        <br />
        Conceptualization: Inspired by React Native behaviors and code splitting methodology, utilized a single useState hook to handle navigation and data filtering
        to force a deeper understanding of React development and optimizing performance.
      </p>
      <p>
        Challenges:
        <br />
        ...
        mapping unique sets of companies, product categories, and styles. Identified and managed rerenders and side effects. Refactored component architecture until
        performance was satisfactory. Minimalized logic by adopting constructor patterns. Centering divs.
      </p>
      <p>
        Best Practices:
        <br />
      ...
      <p>
        Performance:
        <br />
        Implemented Intersectional Observer API for optimized re-renders via useState. Utilized constructor pattern for reusable product filter components. Carefully
        opted-in to React's performance hooks such as useCallback and useMemo. Used data fallbacks in the event that functions failed to fire or return through use
        of undefined checks and conditional rendering.
      </p>
      <p>
