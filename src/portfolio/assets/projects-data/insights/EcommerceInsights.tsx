  ...
  return (
    <>
      ...
      <p>
        ...
        product categories. The vast majority of the application's data was dealt with, resolving any pending issues.
      </p>
      <p>
      ...
      <p>
        ...
        imperfect, experimental, and fun. I put a lot of emphasis on subtle element interactions throughout the application. Additionally, covered all edge cases for
        conditional mapping of images and data. Please note that if your monitor(s) are not calibrated, the neumorphic styling that is not suitable for production
      ...
      <p>
        ...
        Expressions to handle field validation. The last step was shopping cart functionality, which gave me the great pleasure of writing useReducer boilerplate. I,
        of course, have not built out user account pages nor integrated Stripe due to a lack of a back-end.
      </p>
    </>
  );
};
