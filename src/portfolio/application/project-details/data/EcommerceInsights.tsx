  ...
  return (
    <section className='projectDetails__article__insights__projectOverview'>
      ...
      <p>
        ...
        conditionals had to be satisfied prior to building components. This posed the challenge of acquiring a database with diverse key value pairs. Pending issues
        ensued from routing to persisting data site-wide and component re-renders. I quickly understood the real challenge of this application was idealizing
        solutions before writing any code.
      </p>
      <p>
        ...
        wrote the database in TSX format, then post-application completion, converted it to JSON. Utilizing the product database, I built numerous custom hooks that
        filtered and returned alphabetized unique data. Naturally, this paved the way for dynamic route mapping, product search functionality, product filters, and
        product categories. The vast majority of the application's data was dealt with, and routes could now be dynamically mapped, resolving any pending issues.
      </p>
      <p>
        ...
        event propagation, and conditional rendering conflicts with animations took the most effort. Conceptualization of the application's UX and UI was the next
        big priority. By blending style structures from miscellaneous domains, I created something imperfect, experimental, and fun. I put a lot of emphasis on
        subtle element interactions throughout the application. Additionally, covered all edge cases for conditional mapping of images and data. Please note that if
        your monitor(s) are not calibrated, the neumorphic styling that is not suitable for production applications, may be lost.
      </p>
      <p>
