    ...
    <div className="navkit__section">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="1.4em" height="1.4em" viewBox="0 0 24 24">
          <path
            fill={useLocation().pathname === '/ecommerce' ? 'white' : 'hsl(0, 0%, 20%)'}
            fillRule="evenodd"
      ...
      <button
        className="ctaBtn"
        style={{
          backgroundColor: useLocation().pathname === '/ecommerce' ? 'white' : 'hsl(0, 0%, 20%)',
          boxShadow:
            useLocation().pathname === '/ecommerce'
              ? 'rgba(255, 255, 255, 0) -1px -1px 20px 0px, rgba(57, 57, 57, 0) -4px -4px 5px 0px, rgba(98, 98, 98, 0) 7px 7px 20px 0px, rgba(0, 0, 0, 0) 4px 4px 5px 0px'
              : '-1px -1px 20px 0px rgba(255, 255, 255, 1), -4px -4px 5px 0px rgba(255, 255, 255, 1), 7px 7px 20px 0px rgba(0, 0, 0, 0.4), 4px 4px 5px 0px rgba(0, 0, 0, 0.3)',
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="1.6em" height="1.6em" viewBox="0 0 24 24">
          <path
            fill={useLocation().pathname === '/ecommerce' ? 'hsl(0, 0%, 20%)' : 'white'}
        ...
        <span style={{ color: useLocation().pathname === '/ecommerce' ? 'hsl(0, 0%, 20%)' : '' }}>Shopping Cart</span>
      </button>
    </div>
  );
};
