...
export function IcOutlinePlayCircle(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 24 24'
      ...
      <path
        fill='currentColor'
        d='M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10s10-4.48 10-10S17.52 2 12 2m0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8s8 3.59 8 8s-3.59 8-8 8m-2.5-3.5l7-4.5l-7-4.5z'
      />
    </svg>
  );
}
...
export function MaterialSymbolsVolumeDown(props: SVGProps<SVGSVGElement>): JSX.Element {
  return (
    <svg
      ...
      <path
        fill='currentColor'
        d='M5 15V9h4l5-5v16l-5-5zm11 1V7.95q1.125.525 1.813 1.625T18.5 12t-.687 2.4T16 16'
      />
    </svg>
  );
}
  ...
  return (
    <svg
      ...
      <path
        ...
        strokeLinejoin='round'
        strokeWidth='2'
        d='M4 4h6v6H4zm10 0h6v6h-6zM4 14h6v6H4zm10 3h6'
      />
    </svg>
  );
}
...
export function IcBaselineArrowLeft(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 24 24'
...
export function IcBaselineArrowRight(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 24 24'
...
export function BxDotsVerticalRounded(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 24 24'
...
export function GameIconsSpy(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 512 512'
