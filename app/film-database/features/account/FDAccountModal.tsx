          ...
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
            <g fill='none' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' strokeWidth='2'>
              <path
                ...
                <animate fill='freeze' attributeName='strokeDashoffset' dur='0.7s' values='32;0'></animate>
              </path>
              <path strokeDasharray='10' strokeDashoffset='10' d='M9 19c-1.41 0 -2.84 -0.56 -3.69 -1.19c-0.84 -0.63 -1.09 -1.66 -2.31 -2.31'>
                <animate fill='freeze' attributeName='strokeDashoffset' begin='0.8s' dur='0.2s' values='10;0'></animate>
              </path>
            </g>
          </svg>
        </button>
